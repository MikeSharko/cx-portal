...
export class AuthStack extends Stack {
    ...
    private createUserPool(){
        this.userPool = new UserPool(this, 'Cx-portal-user-Pool', {
        ...
        new CfnOutput(this, 'Cx-portal-user-PoolId', {
            value: this.userPool.userPoolId
        })
    }
    private createUserPoolClient(){
        this.userPoolClient = this.userPool.addClient('Cx-portal-PoolClient', {
            authFlows: {
        ...
        new CfnOutput(this, 'CxPortalResourcePoolClientId', {
            value: this.userPoolClient.userPoolClientId
        })
    }

    private createAdminsGroup(){
        new CfnUserPoolGroup(this, 'CxPortalResourceAdmins', {
